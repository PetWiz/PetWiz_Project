    ...
    <div class="parallax-container">
        ...
        <div class="container center">
            ...
            <div class="row">
                ...
                <div class="fb-login-button" data-max-rows="5" data-size="xlarge" data-show-faces="false" data-auto-logout-link="true", scope="public_profile,email,user_birthday,user_hometown,user_friends", onlogin="checkLoginState();">Entra desde Facebook</div><!--,user_birthday,user_hometown-->
            </div>
