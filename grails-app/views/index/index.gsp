        ...
        if (response.status === 'connected') {
           ...
           // window.location = "${createLink(uri:'/person/home.gsp')}"
            ...
            //Register or login user
                document.location.href= '${createLink(controller: 'index' , action:'register_login')}?pamans='
    ...
    <div class="parallax-container">
        ...
        <div class="container center">
            ...
            <div class="row">
                ...
                <div class="fb-login-button" data-max-rows="2" data-size="large" data-show-faces="false" data-auto-logout-link="true", scope="public_profile,email,user_birthday,user_hometown"></div><!--,user_birthday,user_hometown-->
            </div>
