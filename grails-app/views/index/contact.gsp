    ...
    <div class="container">
        ...
        <div class="row black center hoverable z-depth-5">
            <div class="card-content petwiz-font">
                <div class="row">
                    <span class="small-text white-text">Contacto</span>
                </div>
                <div class="row">
                    <div class="col s12 m12 l12center white-text">
                        Aca encontrarás los datos de contacto de cada uno de los desarrolladores de Petwiz
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="card petwiz-blue darken-1" >
                                        <div class="card-content white-text">
                                            ...
                                            <p>Correo: cacoguaa@unal.edu.co </p>
                                            <p>Facebook:  <a href="https://www.facebook.com/AceDarkMasterDj?ref=ts&fref=ts">Facebook</a> </p>
                                        </div>
                                    </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="card petwiz-blue darken-1" >
                                        <div class="card-content white-text">
                                            ...
                                            <p>Correo: jlcasasg@unal.edu.co  </p>
                                            <p>Facebook:  <a href="https://www.facebook.com/JessCgonzalez?fref=ts">Facebook</a> </p>
                                        </div>
                                    </div>
                                    <a href="#!" class=" modal-action modal-close black waves-effect waves-grey btn">Entendido</a>
                                </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="card petwiz-blue darken-1" >
                                        <div class="card-content white-text">
                                            ...
                                            <p>Correo: sablancom@unal.edu.co </p>
                                            <p>Facebook:  <a href="https://www.facebook.com/santiagoandres.blancomarquez">Facebook</a> </p>
                                        </div>
                                    </div>
                                    <a href="#!" class=" modal-action modal-close black waves-effect waves-grey btn">Entendido</a>
                                </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="card petwiz-blue darken-1" >
                                        <div class="card-content white-text">
                                            ...
                                            <p>Correo: mssogamosog@unal.edu.co  </p>
                                            <p>Facebook:  <a href="https://www.facebook.com/michael.s.gonzalez2211?fref=ts">Facebook</a> </p>
                                        </div>
                                    </div>
                                    <a href="#!" class=" modal-action modal-close black waves-effect waves-grey btn">Entendido</a>
                                </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="card petwiz-blue darken-1" >
                                        <div class="card-content white-text">
                                            ...
                                            <p>Correo: esrinconp@unal.edu.co </p>
                                            <p>Facebook:  <a href="https://www.facebook.com/erin.rincon.7?fref=ts">Facebook</a> </p>
                                        </div>
                                    </div>
                                    <a href="#!" class=" modal-action modal-close black waves-effect waves-grey btn">Entendido</a>
                                </div>
